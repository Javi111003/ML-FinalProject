...
Los registros reportan fechas entre las 4 de la madrugada y 12 de la tarde en UTC (lo que serían las 12 de la madrugada y 8 de la mañana hora de Cuba `UTC-4') del día 1 de octubre de 2025.
...
En las horas registradas se muestra un consumo significativo en el horario entre las 12 y 2 de la madrugada (ver Figura \ref{fig:ptr_v}).
...
En las horas registradas se observa un pequeño aumento del consumo en el horario entre las 6 y 8 de la mañana (ver Figura \ref{fig:ptr_s}). No obstante no se distinguen diferencias significativas.
...
\section{Predicciones de servicios}
Utilizando los módulos del \textit{framework} se hicieron predicciones de cada uno de los servicios del estudio. 
...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de datos.}
    \label{fig:pred_d}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de voz.}
    \label{fig:pred_v}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de sms.}
    \label{fig:pred_s}
\end{figure}
