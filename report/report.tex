...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de datos. Se estima que se comporte creciente en el tiempo.}
    \label{fig:pred_t_d}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de voz. Se espera un brusco descenso pero luego se mantiene constante en el tiempo.}
    \label{fig:pred_t_v}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Predicción sobre consumo de sms. Se proyectan variaciones sostenidas a lo largo del tiempo}
    \label{fig:pred_t_s}
\end{figure}
