...
pequeñas diferencias en el orden de eficiencia según el servicio (ver Figura \ref{fig:pred_d}, Figura \ref{fig:pred_v} y Figura \ref{fig:pred_s} respectivamemte).
...
(ver Figura \ref{fig:pred_t_d}, Figura \ref{fig:pred_t_v} y Figura \ref{fig:pred_t_s} respectivamemte).
...
No solo \textbf{agilizó el ciclo de experimentación}, sino que también \textbf{proporcionó una base objetiva y reproducible} para la selección del modelo final. 
